// Visual identity (gradient + accent color) for every category the catalog
// supports. Products only use a subset today; the rest are ready as soon as
// new products are added — no card/template changes needed later.
export const CATEGORY_META = {
  "laptops": { label: "Notebooks", c1: "#12283f", c2: "#0a1622", accent: "#4da3ff", glow: "rgba(77,163,255,.45)" },
  "desktop-computers": { label: "Computadores Desktop", c1: "#241238", c2: "#140a20", accent: "#a374ff", glow: "rgba(163,116,255,.45)" },
  "gaming": { label: "Gamer", c1: "#3a0f24", c2: "#1c0712", accent: "#ff4d7e", glow: "rgba(255,77,126,.45)" },
  "smartphones": { label: "Smartphones", c1: "#0b3535", c2: "#061c1c", accent: "#2dd4bf", glow: "rgba(45,212,191,.4)" },
  "printers": { label: "Impressoras", c1: "#3a2a0d", c2: "#1e1607", accent: "#ffb020", glow: "rgba(255,176,32,.4)" },
  "networking": { label: "Redes", c1: "#0c3247", c2: "#061a26", accent: "#38bdf8", glow: "rgba(56,189,248,.4)" },
  "ssd-storage": { label: "SSD & Armazenamento", c1: "#132a17", c2: "#0a160c", accent: "#4ade80", glow: "rgba(74,222,128,.4)" },
  "ram-memory": { label: "Memória RAM", c1: "#2c1338", c2: "#170a1e", accent: "#c084fc", glow: "rgba(192,132,252,.4)" },
  "monitors": { label: "Monitores", c1: "#132436", c2: "#0a131e", accent: "#60a5fa", glow: "rgba(96,165,250,.4)" },
  "accessories": { label: "Acessórios", c1: "#332107", c2: "#1a1104", accent: "#fb923c", glow: "rgba(251,146,60,.4)" },
  "audio": { label: "Áudio", c1: "#2a1332", c2: "#150a1a", accent: "#e879f9", glow: "rgba(232,121,249,.4)" },
  "security-cameras": { label: "Câmeras de Segurança", c1: "#0f2e1e", c2: "#08170f", accent: "#34d399", glow: "rgba(52,211,153,.4)" },
  "cables": { label: "Cabos", c1: "#302f0d", c2: "#181706", accent: "#facc15", glow: "rgba(250,204,21,.4)" },
  "office-equipment": { label: "Escritório", c1: "#331414", c2: "#1a0a0a", accent: "#f87171", glow: "rgba(248,113,113,.4)" }
};
...
// declared order — the filter chips and Home category tiles read from this.
